...
<style>
  ...
  .overlay {
    background-color: yellow; /* Overlay color with 50% opacity */
    width: 100%;
    height: 100%;
    display: flex;
  ...
  .btn-register {
    background-color: magenta; /* Black */
    margin-left: 20px;
  }

  .btn-register:hover {
    background-color: green; /* Darker Black */
  }
...
<body style="background-image: url('./Images/Labor.jpeg');background-repeat: no-repeat;background-size: cover;">

<div class="overlay">
  <div class="container">
    <h1 style="color:black;">WELCOME TO LABOR MANAGEMENT SYSTEM</h1>
    <p><i><b>All Labor you Wants Are Here To Our Website</b></i></p>
